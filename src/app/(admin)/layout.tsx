  ...
  return (
    <div className="admin-layout min-h-screen flex relative" style={{ background: '#0f1117' }}>
      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0">
        {/* Top header */}
        <header
          className="sticky top-0 z-30 h-[56px] flex items-center justify-between px-6 shrink-0"
          style={{
        ...
        >
          <div className="hidden md:flex items-center gap-2">
            <span className="font-semibold text-xs text-[#64748b] uppercase tracking-widest">Admin Console</span>
          </div>
        ...
        <main className="flex-1 p-5 sm:p-7 max-w-[1440px] w-full mx-auto">{children}</main>
      </div>
    </div>
  )
}
